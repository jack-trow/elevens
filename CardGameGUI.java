...
public class CardGameGUI extends JFrame implements ActionListener {
    ...
    private static final int BUTTON_LEFT = 450;
    ...
    private void initDisplay()  {
        Color darkGreen = new Color(4,69,17);
        panel = new JPanel() {
        ...
        instructionsMsg = new JLabel("<html><i>Instructions: Choose two cards to make 11. Ace = 1, Jack+Queen+King = 11</i><html>");
        instructionsMsg.setFont(new Font("Monospace", Font.BOLD, 15));
        instructionsMsg.setForeground(Color.WHITE);
        panel.add(instructionsMsg);
        instructionsMsg.setBounds(450, 10, 200, 90);

        winMsg = new JLabel();
        winMsg.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 200, 70);
        ...
        lossMsg = new JLabel();
        lossMsg.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 200, 70);

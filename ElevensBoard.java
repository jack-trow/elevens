...
public class ElevensBoard extends Board {
   /*
    ...
    var icon = new ImageIcon("https://codehs.com/uploads/ea448a8d083b4492d27fb5f45cc190e0");
	...
	public boolean anotherPlayIsPossible() {
		/* *** TO BE IMPLEMENTED IN ACTIVITY 9 *** */
		List<Integer> liveCards = cardIndexes();
		return containsPairSum11(liveCards) || containsJQK(liveCards);
	}
